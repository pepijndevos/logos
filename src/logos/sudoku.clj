...
(def almost-board [5 3 4 6 7 8 9 1 (lvar)
                   6 7 2 1 9 5 3 4 (lvar)
                   1 9 8 3 4 2 5 6 (lvar)
                   8 5 9 7 6 1 4 2 (lvar)
                   4 2 6 8 5 3 7 9 (lvar)
                   7 1 3 9 2 4 8 5 (lvar)
                   9 6 1 5 3 7 2 8 (lvar)
                   2 8 7 4 1 9 6 3 (lvar)
                   3 4 5 2 8 6 1 7 (lvar)])

(def empty-board (repeatedly 81 lvar))

(defn remember-o [x l out]
  (cond-e
   ((cons-o x out l))
   ((exist [f r i]
           (cons-o f r l)
